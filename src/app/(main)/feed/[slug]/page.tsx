...
export async function generateMetadata({
  ...
  const micropost = await getMicropostBySlug(resolvedParams.slug);
...
export async function generateStaticParams(): Promise<{ slug: string }[]> {
  const slugs = await getAllMicropostSlugs();
...
export default function MicropostPage({
  ...
  const micropost = use(getMicropostBySlug(resolvedParams.slug));
